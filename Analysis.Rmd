...
str(mtcars)
```
The complete data set consist of 32 different car models, with a few different variables measured for each car. (Original data set can be found in *Biometrics, Vol. 37, No. 2. (Jun. 1981, pp. 391-411.)* along with a very in-dept analysis by *H.V.Henderson & P.F.Velleman* of the set and it's value as a predicting model compared to *Hocking (1976)* among other things which is out of this small assignments idea)
